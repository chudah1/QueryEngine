# Item 2 Claim Annotation Guide v2
...
- Assert a period only when the evidence or its scope heading supports it.
...
- When a heading supplies the period or business scope, preserve that heading as
  `scope_quote`. The combination of scope and evidence must identify one source
  occurrence.
